...
<body>
<div class="container">
    <form class="form-horizontal form-napthengay" role="form" method="post" action="{{ url('napthe/store') }}">
        @csrf
        <div align=center><img src="{{ asset('assets/css/logo-web-napthengay.png') }}"></div>
        <br>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" id="txtpin" name="txtpin" placeholder="Mã thẻ"
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" id="txtseri" name="txtseri" placeholder="Số seri"
                       data-toggle="tooltip" data-title="Mã seri nằm sau thẻ">
            </div>
        </div>

        <div class="form-group">
            <div class="col-lg-offset-2 col-lg-10">
                <button type="submit" class="btn btn-primary" name="submit">Nạp thẻ</button>
            </div>
        </div>
    </form>
</div>
