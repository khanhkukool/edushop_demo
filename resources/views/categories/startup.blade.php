...
@section('title','Kinh doanh - khởi nghiệp')
@section('aside')
    <!-- ASIDE -->
    <div id="aside" class="col-md-3">
        <!-- aside widget -->
        <div class="aside">
            <h3 class="aside-title">Kinh doanh - khởi nghiệp</h3>
            <ul>
                <li class="select-category"><a href="#">Quản trị kinh doanh</a></li>
                <li class="select-category"><a href="#">Kinh doanh cá nhân</a></li>
            </ul>
        </div>
        <!-- /aside widget -->
