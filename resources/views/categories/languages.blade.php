...
@section('aside')
    ...
    <div id="aside" class="col-md-3">
        <!-- aside widget -->
        <div class="aside">
            <h3 class="aside-title">Ngoại ngữ</h3>
            <ul>
                <li class="select-category"><a href="#">Tiếng Anh</a></li>
                <li class="select-category"><a href="#">Tiếng Trung</a></li>
                <li class="select-category"><a href="#">Tiếng Nga</a></li>
                <li class="select-category"><a href="#">Tiếng Pháp</a></li>
                <li class="select-category"><a href="#">Tiếng Nhật</a></li>
                <li class="select-category"><a href="#">Tiếng Hàn</a></li>
            </ul>
        </div>
        <!-- /aside widget -->
