...
@section('title','Kỹ năng sống')
@section('aside')
    <!-- ASIDE -->
    <div id="aside" class="col-md-3">
        <!-- aside widget -->
        <div class="aside">
            <h3 class="aside-title">Phong cách sống</h3>
            <ul>
                <li class="select-category"><a href="#">Kỹ năng mềm</a></li>
                <li class="select-category"><a href="#">Xây dựng hình ảnh cá nhân</a></li>
            </ul>
        </div>
        <!-- /aside widget -->
